...
uint16_t _TRACE_NV2A_PGRAPH_SURFACE_CPU_READ_DSTATE;
uint16_t _TRACE_NV2A_PGRAPH_SURFACE_CPU_WRITE_DSTATE;
...
TraceEvent _TRACE_NV2A_PGRAPH_SURFACE_CPU_READ_EVENT = {
    .id = 0,
    .name = "nv2a_pgraph_surface_cpu_read",
    .sstate = TRACE_NV2A_PGRAPH_SURFACE_CPU_READ_ENABLED,
    .dstate = &_TRACE_NV2A_PGRAPH_SURFACE_CPU_READ_DSTATE
};
TraceEvent _TRACE_NV2A_PGRAPH_SURFACE_CPU_WRITE_EVENT = {
    .id = 0,
    .name = "nv2a_pgraph_surface_cpu_write",
    .sstate = TRACE_NV2A_PGRAPH_SURFACE_CPU_WRITE_ENABLED,
    .dstate = &_TRACE_NV2A_PGRAPH_SURFACE_CPU_WRITE_DSTATE
};
...
TraceEvent *hw_xbox_nv2a_trace_events[] = {
    ...
    &_TRACE_NV2A_PGRAPH_SURFACE_CPU_READ_EVENT,
    &_TRACE_NV2A_PGRAPH_SURFACE_CPU_WRITE_EVENT,
