...
{
    if (trace_event_get_state(TRACE_LURING_RESUBMIT_SHORT_READ)) {
        if (qemu_loglevel_mask(LOG_TRACE)) {
#line 67 "../block/trace-events"
            qemu_log("luring_resubmit_short_read " "req %p nread %d" "\n", req, nread);
#line 1145 "trace/trace-block.h"
        }
    }
}
